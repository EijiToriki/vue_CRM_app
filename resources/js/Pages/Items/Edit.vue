                                ...
                                <div class="flex flex-wrap -m-2">
                                  ...
                                  <div class="p-2 w-full">
                                    <div class="relative">
                                      ...
                                      <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="1" class="ml-2 mr-4" >
                                      <label class="ml-2 mr-4">販売中</label>
                                      <input type="radio" id="is_selling" name="is_selling" v-model="form.is_selling" value="0" class="ml-2 mr-4" >
