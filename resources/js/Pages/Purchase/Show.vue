                            ...
                            <div class="container px-5 py-8 mx-auto">
                              <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                <div class="flex flex-wrap -m-2">
                                  ...
                                  <div class="p-2 mt-4 w-full">
                                    <div>
                                      <label for="totalPrice" class="leading-7 text-sm text-gray-600">ステータス</label><br>
                                      <div v-if="props.order[0].status == true" type="number" id="totalPrice" name="totalPrice" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        未キャンセル
                                      </div>
                                      <div v-if="props.order[0].status == false" type="number" id="totalPrice" name="totalPrice" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        キャンセル済
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="p-2 mt-4 w-full">
                                    <div>
                                      <label for="totalPrice" class="leading-7 text-sm text-gray-600">キャンセル日</label><br>
                                      <div v-if="props.order[0].status == false" type="number" id="totalPrice" name="totalPrice" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
